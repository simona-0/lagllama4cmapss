...
class LagLlamaLightningModule(LightningModule):
    ...
    def __init__(
        ...
        log_train_loss: bool = False # added this line on 04.07 for w&b
    ):
        super().__init__()
        ...
        self.log_train_loss = log_train_loss # added this line on 04.07 for w&b
        self.transforms = []
        aug_probs = dict(
    ...
    def training_step(self, batch, batch_idx: int):  # type: ignore
        ...
        if self.log_train_loss: 
            wandb.log({"train_loss": train_loss_avg}) # these two lines added on 04.07 for w&b
