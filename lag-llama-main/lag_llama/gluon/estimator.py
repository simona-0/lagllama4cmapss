...
class LagLlamaEstimator(PyTorchLightningEstimator):
    ...
    def __init__(
        ...
        weight_decay: float = 0, # deactivate L2 regularisation
    ...
    def create_lightning_module(self, use_kv_cache: bool = False) -> pl.LightningModule:
        ...
        if self.ckpt_path is not None:
            return LagLlamaLightningModule.load_from_checkpoint(
                ...
                log_train_loss=True,  # Add this line on 04.07 for w&b
            )
        else:
    ...
    def create_training_data_loader(
        ...
        **kwargs,
        ...
        wandb.init(project="lag_llama_04_07") # added this line on 04.07 for w&b support
